...
//@return	int	The error message, related to $TCPClient::Error::[none|connectionFailed|dnsFailed|invalidResponse|invalidRedirect|invalidDownloadLocation]
